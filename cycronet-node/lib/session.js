...
class Session {
  ...
  request(method, url, { params = null, headers = null, cookies = null, data = null, json = null, timeout = null, verify = null, allowRedirects = true } = {}) {
    if (this._closed) {
    ...
    const responseDict = this._client.request({
  ...
  uploadFile(url, filePath, { fieldName = "file", additionalFields = null, headers = null, cookies = null, timeout = null, verify = null } = {}) {
  ...
  downloadFile(url, savePath, { headers = null, cookies = null, timeout = null, verify = null, chunkSize = 8192 } = {}) {
    const response = this.get(url, { headers, cookies, timeout, verify });
